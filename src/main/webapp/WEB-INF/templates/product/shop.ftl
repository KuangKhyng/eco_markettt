        ...
        <div class="row g-2">
            <div class="col-md-3">
                <div class="t-products p-2 px-1">
                    <h4 style="font-family: 'Comic Sans MS'; font-size: 50px; color: forestgreen;class="text-uppercase">Кактегории</h4>
                    <div class="list-group">
                        <a href="/shop/products"
                           class="list-group-item list-group-item-action list-group-item-success <#if selectCategoryTag == "all">active</#if>">Все</a>
                        <#list categories as category>
                            <a href="/shop/products/${category.tag}"
                               class="list-group-item list-group-item-action list-group-item-success <#if selectCategoryTag == category.tag>active</#if>">${category.name}</a>
                        </#list>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card-body align-items-center text-center">
                                    ...
                                    <div class="row pt-3">
                                        ...
                                        <form class="<#if isAuth>col-6<#else>col-12</#if>" method="get"
                                            ...
                                            <button class="my-1 btn btn-success btn-block" type="submit" href="/${product.id}">
                                                Подробнее
                                            </button>
                                        </form>
                                        <#if isAuth>
